...
# Pour Railway : On utilise le répertoire courant pour éviter les erreurs de droits
# Mais attention : Sans Volume Railway, les données SQLite sont supprimées à chaque Deploy.
DB_PATH = "owpc_final_permanent.db" 
