...
async def get_user(uid: int):
    ...
    # On ajoute juste missions_done à la fin du SELECT
    ...
    return {
        ...
        "missions": r[10].split(",") if r[10] else [] # Envoi des missions au JS
    }

# --- NOUVELLE ROUTE MISSION ---
...
async def mission_api(request: Request):
    ...
    if mid not in done:
        ...
        # Gain de +20 Genesis par mission
...
<head>
    ...
    <style>
        ...
        .energy-fill { background: linear-gradient(90deg, #FFD700, #FFA500); height: 100%; width: 0%; transition: width 0.5s cubic-bezier(0.4, 0, 0.2, 1); box-shadow: 0 0 10px rgba(255, 215, 0, 0.3); }
    ...
    <script>
        ...
        async function refresh() {
            try {
                ...
                // Masquer les missions terminées
        ...
        async function doTask(id, url) {
            ...
            }, 5000); // Attendre 5s avant de valider
        }
